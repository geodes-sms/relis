...
class NominalVariables(Enum):
    has_choco = Variable("has_choco", "Has chocolate", FieldClassificationType.NOMINAL, False)
    brand = Variable("brand", "Brand", FieldClassificationType.NOMINAL, False)
    cocoa_origin = Variable("cocoa_origin", "Cocoa origin", FieldClassificationType.NOMINAL, False)
    cocoa_level = Variable("cocoa_level", "Cocoa level", FieldClassificationType.NOMINAL, False)
    types = Variable("types", "Types", FieldClassificationType.NOMINAL, False)
...
project_classification_data = pd.read_csv('./hot_chocolate.csv', encoding='utf8')
