#Install and load the necessary packages
		...
		# Importing data.csv
		relis_data <- read.csv("relis_classification_demo_relis.csv", header = TRUE) # Replace this with the name of your imported data file
		rm(relis_classification_demo_relis)           # Replace this with the name of your imported data file
