#Install and load the necessary packages
		...
		# Importing data.csv
		relis_data <- read.csv("relis_classification_adminPrjt.csv", header = TRUE) # Replace this with the name of your imported data file
		rm(relis_classification_adminPrjt)           # Replace this with the name of your imported data file
		config_file <- data.frame(Column_name = c("Transformation.name","Transformation.Language","Scope","Bidirectional","Intent","Intent.relation","Publication.year","Venue","Search.Type") , 
		Scale = c("Text","Nominal","Nominal","Nominal","Nominal","Nominal","Continuous","Nominal","Nominal")) 
		# Beautifying Title
