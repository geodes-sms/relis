<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
        ...
        <div class="profile_pic">
          ...
          if (($this->session->userdata('user_picture'))) {
            ...
            if (!empty($user_picture)) {
              ...
              'data:image/png;base64,' . base64_encode($user_picture);
            }
          }
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
      ...
      foreach ($left_menu as $key_menu_section => $value_menu_section) {
        ...
        <div class="menu_section">
          <h3>
            <?php echo lng($value_menu_section['label']) ?>
          </h3>
          <?php
    ...
    <div class="sidebar-footer hidden-small">
      <a data-toggle="tooltip" data-placement="top" title="<?php echo lng_min('Main') ?>"
        href="<?php echo base_url() ?>project/projects_list.html">
      ...
      <a data-toggle="tooltip" data-placement="top" title="<?php echo lng_min('Dashboard') ?>"
        href="<?php echo base_url() ?>home.html">
        <span class="glyphicon glyphicon-th" aria-hidden="true"></span>
      </a>
      <a data-toggle="tooltip" data-placement="top" title="<?php echo lng_min('Log Out') ?>"
        href="<?php echo base_url() ?>/user/discon">
