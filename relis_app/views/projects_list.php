            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
               ...
               //  print_test($projects);
                 ...
                 //	print_test($value);
                 ?>
                 <a href="<?php echo base_url().'home/set_project/'.$value['project_label'].'/'.$value['project_id'].'/'.$value['project_title'] ?>">
                        ...
                        <div class="thumbnail">
                          <div class="image view view-first">
                            ...
                            <div class="mask" >
                              ...
                              <?php 
                              echo anchor('home/set_project/'.$value['project_label'].'/'.$value['project_id'].'/'.$value['project_title'],' &nbsp &nbsp <i class="fa fa-paper-plane"></i> ','title="'.lng_min('Go to the project').'"');
