        ...
        <!-- top tiles -->
          <div class="row tile_count centre">
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <?php echo anchor('relis/manager/list_paper/assigned_me',' <div class="count ">'.nombre($assigned_me_papers).'</div>')?>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <?php echo anchor('relis/manager/list_paper/excluded',' <div class="count red ">'.nombre($excluded_papers).'</div>')?>
							...
							if(empty($result_value['rows'])){
								...
								echo lng("No value !");
									...
									foreach($result_value['rows'] as $k=>$v){
										echo "<tr>";
										$link=anchor("relis/manager/search_classification/".$result_value['field_name']."/".$v['field'],"<u>".$v['field_desc']."</u>");
