	      ...
	      <div class="col-md-12 col-sm-12 col-xs-12">
	        <div class="x_panel">
	          ...
	          <div class="x_content" style="min-height:400px ">
                ...
                function generateDownloadDescription($filename, $description)
                {
                  if (file_exists($filename)) {
                    $file_size = filesize($filename);
                    $formatted_size = ($file_size > 1000 ? round($file_size / 1000) : round($file_size / 1000, 1)) . ' Kb';
                    $last_update = date("Y-m-d h:i:s", filemtime($filename));
                    return "<i class='fa fa-download'></i> Download $description ($formatted_size  Last update: $last_update)";
                  } else {
                    return "";
                  }
                }

                $r_environment_dsc = generateDownloadDescription($r_environment_filename, "R");
                $python_environment_dsc = generateDownloadDescription($python_environment_filename, "Python");
                ...
                ?>
	              <table class="table table-striped table-hover list_export_x">
	                ...
	                <tr>
	                  ...
	                  <td><a href="<?php echo base_url(); ?>reporting/download/relis_classification_<?php echo project_db(); ?>.csv"><?php echo $class_dsc ?></a></td>
	                  <td><a href="<?php echo base_url(); ?>reporting/result_export_classification"><i class="fa fa-refresh"></i><?php echo lng('Update file') ?></a></td>
	                  <td></td>
	                </tr>
	                <tr>
	                  <td>Papers</td>
	                ...
	                <tr>
	                  ...
	                  <td><a href="<?php echo base_url(); ?>reporting/result_export_papers_bib"><i class="fa fa-refresh"></i><?php echo lng('Update file') ?></a></td>
	                </tr>

	                <tr>
	                  <td>Papers included (BibTeX)</td>
	                  <td><a href="<?php echo base_url(); ?>reporting/download/relis_paper_bibtex_Included_<?php echo project_db(); ?>.bib"><?php echo  $paper_bib_dsc_Included ?></a></td>
	                  <td><a href="<?php echo base_url(); ?>reporting/result_export_included_papers_bib"><i class="fa fa-refresh"></i><?php echo lng('Update file') ?></a></td>
	                </tr>

	                <tr>
	                  <td>Papers Excluded (BibTeX)</td>
	                  <td><a href="<?php echo base_url(); ?>reporting/download/relis_paper_bibtex_Excluded_<?php echo project_db(); ?>.bib"><?php echo  $paper_bib_dsc_Excluded ?></a></td>
	                  <td><a href="<?php echo base_url(); ?>reporting/result_export_excluded_papers_bib"><i class="fa fa-refresh"></i><?php echo lng('Update file') ?></a></td>
	                </tr>

	                <tr>
	                  <td>Papers Excluded Screening(CSV)</td>
	                  <td><a href="<?php echo base_url(); ?>reporting/download/relis_paper_excluded_screen_<?php echo project_db(); ?>.csv"><?php echo  $screen_excluded_dsc ?></a></td>
	                  <td><a href="<?php echo base_url(); ?>reporting/result_export_excluded_screen"><i class="fa fa-refresh"></i><?php echo lng('Update file') ?></a></td>
	                </tr>

	                <tr>
	                  <td>Papers Excluded Classification (CSV)</td>
	                  <td><a href="<?php echo base_url(); ?>reporting/download/relis_paper_excluded_class_<?php echo project_db(); ?>.csv"><?php echo  $class_excluded_dsc ?></a></td>
	                  <td><a href="<?php echo base_url(); ?>reporting/result_export_excluded_class"><i class="fa fa-refresh"></i><?php echo lng('Update file') ?></a></td>
	                </tr>
