         ...
         <?php if(!empty($home_info))
         {
           ...
           <div class="row">
            ...
            // box_header("ReLiS A tool for conducting Systematic Review","",12,12,12);
             ?>
             <h1 class="lead"><?php echo !empty($home_info['info_title'])?$home_info['info_title']:""?></h1>
            <hr/> 
          ...
          ?>
           ...
           <hr/>
           <h1 class="lead"><?php echo lng('What can you do in ReLiS?')?></h1>  
                    ...
                    <li>
                        <div class="block" >
                          <div class="block_content">
                            <h2 class="title">
                             <a><?php echo !empty($feature['info_title'])?$feature['info_title']:""?></a>
                            </h2>
          ...
          if(!empty($home_ref))
          {
          	?>
                     <div class="row">
                       ...
                       <h1 class="lead"><?php echo !empty($home_ref['info_title'])?$home_ref['info_title']:""?></h1>
