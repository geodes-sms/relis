                            ...
                            <li class="">
                                <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <?php
                                        ...
                                        if(!empty($this->session->userdata('user_picture'))) {
                                ...
                                <ul class="dropdown-menu dropdown-usermenu pull-right">
                                    <li><a href="<?php echo base_url()?>/user/discon""><i class="fa fa-sign-out pull-right"></i><?php echo lng_min('Log Out')?></a></li>
                                    <li><a href="<?php echo base_url();?>element/display_element/detail_user_min_ed/<?php echo active_user_id()?>"></i><?php echo lng_min('Profile')?></a></li>
                                </ul>
                            </li>
