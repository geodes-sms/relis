...
function get_classification()
{
	...
	$fields['class_tool_or_language2'] = array(
		'field_title' => 'Tool or Language used',
		'field_type' => 'number',
		'field_value' => 'normal',
		'field_size' => 11,
		'mandatory' => ' mandatory ',
		...
		//simple
		'input_select_values' => 'classification_language;class_lang_name',
		//the reference table and the field to be displayed
		'compute_result' => 'no',
		'on_add' => 'not_set',
	...
	$fields['class_scope'] = array(
		...
		//drill_down
		'input_select_values' => 'classification_scope;class_scope_scope_id',
		//the reference table and the field to be displayed
	...
	$fields['class_intent'] = array(
		...
		'input_select_source_type' => 'drill_down',
		//drill_down
		'input_select_values' => 'classification_intent;class_intent_intent_id',
		//the reference table and the field to be displayed
	...
	$fields['class_intent_relation'] = array(
		...
		'input_select_source_type' => 'drill_down',
		//drill_down
		'input_select_values' => 'classification_intent_relation;class_intent_rel_relation_id',
		//the reference table and the field to be displayed
