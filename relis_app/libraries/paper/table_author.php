<?php 
/*
	The function creates a configuration array with various settings for managing authors. 
...
function get_author() {
	...
	/*
		The configuration also includes settings for the list view:
			...
			- links: An array defining links for editing, viewing, deleting authors.
