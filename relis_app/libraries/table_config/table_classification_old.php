...
function get_classification() {
	   ...
	   //$config['search_by']='class_year';// separer les champs par virgule
		...
		$fields['class_tool_or_language2']=array(
				...
				'input_type'=>'select',
				'input_select_source'=>'table',
				'input_select_source_type'=>'drill_down',//simple
				'input_select_values'=>'classification_language;class_lang_name',//the reference table and the field to be displayed
				'compute_result'=>'no',
