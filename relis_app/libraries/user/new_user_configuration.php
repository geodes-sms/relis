...
/*
	This function returns a configuration array for managing new_users. 
	Here are the key components of the configuration:
		- table_name: The name of the table associated with new_users.
		- table_id: The primary key field for the new_users table.
		- table_active_field: The field used to determine whether a record is active or deleted.
		- order_by: The sorting order for the new_users in the list view.
		- The configuration includes a fields array, which defines the fields of the new_users table.
*/
function get_config_new_user()
{
	...
	/*
		The $operations array defines different operations or actions that can be performed on new_users. 
