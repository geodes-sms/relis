...
function get_classification_demoTestProject()
{
	...
	$result['project_title'] = 'Demo Test Project update from editor 2';
	$result['project_short_name'] = 'demoTestProjectUpdateFromEditor';
    ...
    $screening['status_to_validate'] = 'Included';
