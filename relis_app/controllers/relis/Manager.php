...
class Manager extends CI_Controller
{
	...
	/**
	 * calculates and returns the completion status of a user for a specific screening phase, 
	 * including the total number of assigned papers, the number of papers that have been screened, 
	...
	//retrieves the screening results for calculating kappa coefficient by querying the database for completed screenings in the active phase
